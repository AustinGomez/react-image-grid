        ...
        <>
            ...
            <div className="lightbox-window">
                <div className="lightbox-header-shadow">
                    <img className="back-button" src="icons/left-arrow.svg" alt="back-button-icon" onClick={onClose} />
                </div>
                <div className="lightbox-image-container">
                    ...
                    <div className="arrow-container right-arrow"
                        ...
                        {showRightArrow ? <img src="icons/chevron-right.svg" alt="right arrow icon"/> : null}
                    </div>
                </div>
            </div>
        </>
